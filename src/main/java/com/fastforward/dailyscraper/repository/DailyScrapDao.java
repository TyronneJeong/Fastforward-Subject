...
public interface DailyScrapDao {
  ...
  /**
   * selectListStockInfoLast5Days - retrive the stock information using parameter.
   *
   * @param stockCode
   * @return StockInfoDto
   */
  ...
  /**
   * selectDailyMarketAmount - Retrive Daily Market Amount by parameter.
   *
  ...
  /**
   * saveStockInfo - Insert Daily Market Amount by parameter.
   *
   * @param dailyMarketAmountDto
   * @return void
   */
  ...
  /**
   * updateDailyMarketAmount - Update Daily Market Amount by parameter.
   *
   * @param dailyMarketAmountDto
   * @return void
   */
